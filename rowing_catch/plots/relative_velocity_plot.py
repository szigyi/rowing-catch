...
from rowing_catch.plots.theme import BG_COLOR_AXES, COLOR_ARMS, COLOR_CATCH, COLOR_FINISH, COLOR_HANDLE
from rowing_catch.plots.utils import setup_premium_plot


def render_relative_velocity(computed_data: dict[str, Any]) -> None:
