...
def test_generate_cycle_df_basic():
    ...
    expected_cols = ['Handle/0/X', 'Handle/0/Y', 'Shoulder/0/X', 'Shoulder/0/Y', 'Seat/0/X', 'Seat/0/Y']
    ...
    assert df['Seat/0/X'].max() <= 1000
    assert df['Handle/0/X'].max() <= 1000
